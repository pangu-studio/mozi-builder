...
func RegisterRoutes(api gin.IRoutes, h *Handler) {
	...
	api.GET("/error-codes", h.ListErrorCodes)
	api.POST("/error-codes", h.SaveErrorCode)
	api.PUT("/error-codes/:code", h.SaveErrorCode)
	api.DELETE("/error-codes/:code", h.DeleteErrorCode)
...
func RegisterUnavailableRoutes(api gin.IRoutes, fallback gin.HandlerFunc) {
	...
	api.GET("/error-codes", fallback)
	api.POST("/error-codes", fallback)
	api.PUT("/error-codes/:code", fallback)
	api.DELETE("/error-codes/:code", fallback)
